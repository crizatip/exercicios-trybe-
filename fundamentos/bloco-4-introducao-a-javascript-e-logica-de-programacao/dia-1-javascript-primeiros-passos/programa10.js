...
const produtoCusto = 20;
const valorVenda = 58;

const imposto =  0.2 * produtoCusto   
const valorFinalCusto = imposto + produtoCusto

const lucro =  valorVenda - valorFinalCusto 


if(produtoCusto <= 0 || valorVenda <= 0){
    console.log("ERRO: Valores Negativos ou ZERO")
}else {
    console.log(lucro)
}